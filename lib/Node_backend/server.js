...
// ----------------------
// UPDATE USER (with bcrypt if password updated)
// ----------------------
...
app.get('/get_events', (req, res) => {
  ...
  const sql = "SELECT event_id, event_name, event_date, event_code FROM events WHERE event_date >= ? ORDER BY event_date ASC";
...
// ----------------------
// (Other endpoints unchanged from your version … stalls, attendance, etc.)
// ----------------------
// ----------------------
